...
const server = app.listen(PORT, async () => {
  ...
  try {
    ...
    console.log(`🚀 [Startup Cleanup] Found ${toDelete.length} duplicates to remove`);
    ...
    if (toDelete.length > 0) {
      ...
      console.log("🚀 [Startup Cleanup] Successfully deleted all duplicates!");
    }
  } catch (cleanErr) {
    console.error("🚀 [Startup Cleanup] Error running database cleanup:", cleanErr);
  }
